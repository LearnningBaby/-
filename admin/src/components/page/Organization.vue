    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-qrcode"></i> 组织机构</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-tab-pane label="学校" name="first">
                    <div class="handle-box">
                        ...
                        <el-input v-model="query.name" placeholder="学校" class="handle-input mr10"></el-input>
                    ...
                    >
                        ...
                        <el-table-column label="校徽 (查看大图)" align="center">
                ...
                <el-tab-pane label="教育机构" name="second">
                    <div class="handle-box">
                        <el-button type="danger" icon="el-icon-delete" class="handle-del mr10" @click="delAllSelection2"
                            >批量删除</el-button
                        >
                        <el-select v-model="query2.state" placeholder="状态" class="handle-select mr10">
                            <el-option key="1" label="启用" value="启用"></el-option>
                            <el-option key="2" label="禁用" value="禁用"></el-option>
                        </el-select>
                        <el-input v-model="query2.name" placeholder="机构" class="handle-input mr10"></el-input>
                    ...
                    >
                        ...
                        <el-table-column label="操作" width="180" align="center">
                            <template slot-scope="scope">
                                <el-button type="text" icon="el-icon-edit" @click="handleEdit2(scope.$index, scope.row)">编辑</el-button>
                                <el-button type="text" icon="el-icon-delete" class="red" @click="handleDelete2(scope.$index, scope.row)"
                                    >删除</el-button
                                >
                            </template>
                        </el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="70px">
                <el-form-item label="状态">
                    <el-select v-model="form.state" class="handle-select mr10">
                        <el-option key="1" label="启用" value="启用"></el-option>
                        <el-option key="2" label="禁用" value="禁用"></el-option>
                    </el-select>
                </el-form-item>
       ...
       <!-- 教育机构 弹出框 -->
        <el-dialog title="编辑" :visible.sync="editVisible2" width="30%">
            <el-form ref="form" :model="form2" label-width="70px">
                <el-form-item label="状态">
                    <el-select v-model="form2.state" class="handle-select mr10">
                        <el-option key="1" label="启用" value="启用"></el-option>
                        <el-option key="2" label="禁用" value="禁用"></el-option>
                    </el-select>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        //机构 触发搜索按钮
        handleSearch2() {
            this.$set(this.query2, 'pageIndex2', 1);
            this.getData();
        },
        //学校 删除操作
        ...
        delAllSelection2() {
            ...
            let str = '';
            this.delList = this.delList2.concat(this.multipleSelection2);
            for (let i = 0; i < length; i++) {
