    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-select v-model="query.state" @change="changeState" placeholder="权限" class="handle-select mr10">
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="70px">
                ...
                <el-form-item label="权限">
                    <el-select  v-model="form.address" class="handle-select mr10">
                        <el-option key="1" label="管理员" value="管理员"></el-option>
                        <el-option key="2" label="超级管理员" value="超级管理员"></el-option>
                    </el-select>
                </el-form-item>
            ...
            <el-form :model="form">
                ...
                <el-form-item label="密码" :label-width="formLabelWidth">
                 ...
                 <el-form-item label="角色" :label-width="formLabelWidth">
                    <el-select v-model="saveForm.role" class="handle-select mr10">
                        <el-option key="1" label="管理员" value="管理员"></el-option>
                        <el-option key="2" label="超级管理员" value="超级管理员"></el-option>
                    </el-select>
                </el-form-item>
